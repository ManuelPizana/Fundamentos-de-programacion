...
class Alumno:
    ...
    def __repr__(self):
        # Representación útil para depuración mostrando identificadores clave.
...
class Carrera:
    ...
    def __repr__(self):
        # Representación breve con el nombre de la carrera.
...
class Materia:
    ...
    def __repr__(self):
        # Representación que incluye la carrera para facilitar trazas.
...
class Profesor:
    ...
    def registra_calificacion(self, alumno: Alumno, calificacion: float):
        # Uso del atributo alumno.calificaciones (dict) para persistir la nota.
    ...
    def __repr__(self):
        # Representación con nombre y materia asociada.
